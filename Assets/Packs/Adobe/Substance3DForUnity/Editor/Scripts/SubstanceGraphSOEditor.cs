...
namespace Adobe.Substance.Editor
{
    ...
    public class SubstanceGraphSOEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _renderTexturesProperty;
        ...
        public void OnEnable()
        {
            ...
            _renderTexturesProperty = serializedObject.FindProperty("RenderTextures");
        ...
        private bool DrawGraph()
        {
            ...
            if (DrawInputs())
            {
                ...
                _ = SubstanceEditorEngine.instance.SubmitAsyncRenderWork(_handler, _target);
                valuesChanged = true;
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    for (int i = 0; i < outputsCount; i++)
                    {
                        ...
                        if (generateAllTextures || isStandard)
                            valueChanged |= DrawOutputTexture(outputProperty, _GeneratedTextureGUI);
                    }
                }
